...
- Next after push: implement canonical tmux-compatible `select-pane` / `selectp` on top of the verified pane target resolver and `pane.focus`. The overall parity goal is not complete.
