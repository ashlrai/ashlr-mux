...
- Next after push: audit canonical `pane.focus` and top-level `focus-pane`; the Windows CLI currently appears to alias pane focus to `surface.focus`, making it the next high-confidence catalog/routing gap. The overall parity goal is not complete.
