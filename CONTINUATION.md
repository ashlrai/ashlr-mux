...
- Next after push: audit and implement canonical `resize-pane` / `pane.resize`, including direction flags/aliases, pane/workspace/window routing, split-tree divider mutation, response, and exact validation/errors. The overall parity goal is not complete.
