...
- Next after push: audit the next canonical tmux selection verb (`select-window` / `selectw`) and implement the highest-confidence unsupported shim command. The overall parity goal is not complete.
