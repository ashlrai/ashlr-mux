...
- Next family after the workspace batch push: select the next dependency-coherent priority-zero batch from the frozen matrix. Preserve the same contract audit, isolated red/green/simplify/green implementation, independent verification, full-gate, evidence-ledger, push, and live-evidence ceiling.
