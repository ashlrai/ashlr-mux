...
- Next after push: audit and implement canonical `last-pane` / `pane.last`, including workspace/window routing, alternate-pane focus semantics, response, and exact errors. The overall parity goal is not complete.
