...
- Next batch: diagnose and fix the Windows desktop test-loader/runtime certification blocker (`0xc0000139 STATUS_ENTRYPOINT_NOT_FOUND`) in an isolated worktree, because it blocks live verification of this and every later desktop family. Preserve the same red/green/simplify/green, independent verification, full-gate, evidence-ledger, and verified-push cadence.
