...
- Next after push: audit and implement canonical `break-pane` / `pane.break`, including optional pane/surface/workspace/window selectors, focus/no-focus precedence, surface detachment into a new workspace, response, and exact errors. The overall parity goal is not complete.
