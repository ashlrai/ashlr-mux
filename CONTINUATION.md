...
- Next after push: close canonical `__tmux-compat -V` / `-v` output (`tmux 3.4`), then resume the broader missing-command/control-method audit. The overall parity goal is not complete.
