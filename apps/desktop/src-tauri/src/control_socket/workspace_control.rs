...
pub(super) fn right_sidebar_control(
    app: &AppHandle,
    params: &serde_json::Map<String, Value>,
) -> ControlCallResult {
    let current = snapshot(app);
...
pub(super) fn right_sidebar_target_exists(
    snapshot: &AppSessionSnapshot,
    params: &serde_json::Map<String, Value>,
) -> bool {
...
pub(super) fn feed_list(app: &AppHandle) -> ControlCallResult {
    let state = app.state::<crate::feed::FeedState>();
    match state.list() {
...
pub(super) fn feed_permission_reply(
    app: &AppHandle,
    params: &serde_json::Map<String, Value>,
) -> ControlCallResult {
...
pub(super) fn feed_question_reply(
    app: &AppHandle,
    params: &serde_json::Map<String, Value>,
) -> ControlCallResult {
    let Some(request_id) = string_param(params, &["request_id"]) else {
...
pub(super) fn feed_exit_plan_reply(
    app: &AppHandle,
    params: &serde_json::Map<String, Value>,
) -> ControlCallResult {
    let Some(request_id) = string_param(params, &["request_id"]) else {
...
pub(super) fn feed_resolve_control(
    app: &AppHandle,
    request_id: &str,
...
pub(super) fn notification_list(app: &AppHandle) -> ControlCallResult {
...
pub(super) fn notification_mutation_result(
...
pub(super) fn notification_dismiss(
    app: &AppHandle,
    params: &serde_json::Map<String, Value>,
) -> ControlCallResult {
...
pub(super) fn notification_mark_read(
    app: &AppHandle,
    params: &serde_json::Map<String, Value>,
) -> ControlCallResult {
    let id = string_param(params, &["id"]);
...
pub(super) fn notification_clear(
    app: &AppHandle,
    params: &serde_json::Map<String, Value>,
) -> ControlCallResult {
    let current = snapshot(app);
...
pub(super) fn notification_create(
    app: &AppHandle,
    params: &serde_json::Map<String, Value>,
) -> ControlCallResult {
    let current = snapshot(app);
...
pub(super) fn notification_jump_to_unread(app: &AppHandle) -> ControlCallResult {
    notification_open_selected(app, None, true)
}

pub(super) fn notification_open_selected(
    app: &AppHandle,
    id: Option<&str>,
    allow_empty: bool,
) -> ControlCallResult {
