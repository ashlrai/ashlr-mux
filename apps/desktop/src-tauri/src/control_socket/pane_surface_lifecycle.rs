...
use selection_events::{focus_selection_events, focused_pane_events, selection_events};

#[path = "pane_surface_lifecycle/surface_focus.rs"]
mod surface_focus;
use surface_focus::surface_focus;

#[path = "pane_surface_lifecycle/surface_move.rs"]
mod surface_move;
use surface_move::surface_move;
...
pub(super) fn dispatch_lifecycle_request(
    ...
    let mut transition = match method {
        ...
        "pane.swap" => pane_swap(snapshot, params, context),
