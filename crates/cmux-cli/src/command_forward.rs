...
pub fn control_command_for(
    ...
    let mapped = match command {
        ...
        "last-pane" => Some(ControlCommand::from_cli(
            "pane.last",
            "last-pane",
        ...
        "focus-pane" => Some(ControlCommand::from_cli(
            "pane.focus",
            "focus-pane",
            pane_focus_params(args)?,
        )),
        "focus-panel" => Some(ControlCommand::from_cli(
            "surface.focus",
            "focus-panel",
...
mod tests {
    ...
    include!("command_forward/pane_tests.rs");
